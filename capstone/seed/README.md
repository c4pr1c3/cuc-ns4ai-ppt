...
> 这是《网络安全（AI 时代版）》渐进式作品 M0 的起点脚手架。fork 它，按 [`overview`](https://github.com/c4pr1c3/cuc-ns4ai-ppt/blob/master/capstone/overview.md) 的 M0-M7 在**同一个仓库**里持续迭代。
...
- 完整 Git 操作规范见 [`Git 指南`](https://github.com/c4pr1c3/cuc-ns4ai-ppt/blob/master/courseware/unit00-intro/labs/git-guide.md)；给自己的仓库配置每次提交自动构建（gitlab-runner）见 [`CI 指南`](https://github.com/c4pr1c3/cuc-ns4ai-ppt/blob/master/courseware/unit00-intro/labs/ci-guide.md)。
